...
description: "This dataset appears to record the weights of newborn babies."
params: 
    source: ""
...
- __Gender__ Gender of baby. Based on weight, we assume that 1 refers to female and 2 refers to male. 
- __Weight__ Weight of baby (grams)
- __Minutes__ (minutes)
- __WaitTimes__ Wait time (minutes)
