...
params: 
    source: ""
    pins_name: 'hathawayj/estuarine_crocodile'
    available: all
---
...
- __Species__ Crocodile species
- __CommonName__ Crocodile common name
- __HeadLength__ Length of crocodile head (cm)
- __BodyLength__ Length of crocodile body (cm)
...
#| file: ../../../data_scripts/estuarine_crocodile.R
```
