...
description: "Count of heart attacks during world cup and not during world cup"
params: 
    source: ""
    pins_name: 'hathawayj/world_cup_heart_attacks'
    available: all
---
...
- __Date:__ Date (Monthname day, YYYY)
- __HeartAttacks:__ Count of heart attacks
- __TimePeriod:__ Time period group (Control, World Cup)
...
#| file: ../../../data_scripts/intro_stats/world_cup_heart_attacks.R
```
