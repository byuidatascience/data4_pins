...
date: "2024-04-30"
categories: [music]
description: "The heights of singers in various sections (Alto, Bass, Soprano, Tenor)"
params: 
    source: ""
    pins_name: 'hathawayj/music_height_long'
    available: all
---
...
- __x__ A unique key for each row
- __variable__ Musical section (Alto, Bass, Soprano, Tenor)
- __value__ Singer height (in)
...
#| file: ../../../data_scripts/intro_stats/music_height_long.R
```
