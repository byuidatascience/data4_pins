...
date: "2024-05-01"
categories: [finance]
description: "Price and volume of NASDAQ shares"
params: 
    source: ""
    pins_name: 'hathawayj/nasdaq_price_and_volume'
    available: all
---
...
- __Symbol__ Unique code for each company
- __Company__ Company name
- __Price..US..__ U.S. Price
- __Share.Volume__ Share volume (total number of shares bought or sold)
...
#| file: ../../../data_scripts/intro_stats/nasdaq_price_and_volume.R
```
