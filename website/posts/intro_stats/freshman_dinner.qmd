...
date: "2024-04-29"
categories: [MATH221]
description: "The number of times freshman students from Colorado and Utah cooked their own dinner in a month"
params: 
    source: "Unknown"
    pins_name: 'hathawayj/freshman_dinner'
    available: all
---
...
- __Freshman.students.from.Utah.__ The number of times a student from Utah cooked their own dinner in a month 
- __Freshman.students.from.Colorado__ The number of times a student from Colorado cooked their own dinner in a month
...
#| file: ../../../data_scripts/intro_stats/freshman_dinner.R
```
