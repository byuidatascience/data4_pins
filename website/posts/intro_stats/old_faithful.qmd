...
author: "MATH 221"
date: "2024-05-01"
categories: [MATH221, environment, geology]
description: "Waiting time between eruptions and the duration of the eruption for the Old Faithful geyser in Yellowstone National Park, Wyoming, USA.\nResearchers observed 272 eruptions of this geyser. The researchers recorded the duration of each eruption (in minutes) and the waiting time until the next eruption (in minutes). "
params: 
    source: "A. Azzalini and A. W. Bowman. A look at some data on the Old Faithful geyser. Applied Statistics, 39:357-365, 1990."
    pins_name: 'hathawayj/old_faithful'
    available: all
---
...
- __Duration:__ Duration of eruption (min)
- __Wait:__ Duration of wait between eruptions (min)
...
#| file: ../../../data_scripts/intro_stats/old_faithful.R
```
