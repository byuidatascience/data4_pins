...
author: "MATH 221"
date: "2024-04-27"
categories: [MATH221, production, efficiency]
description: "The Levi-Strauss clothing manufacture plant in Albuquerque, New Mexico gets its cloth supplies from other supplying plants.  These data were collected in order to determine whether there was a difference in waste management between five supplier plants.\nThe quality control department collects data weekly on percentage waste (run-up).  These values are relative to what computer pattern layouts would achieve.  Negative values indicate that the employees did better than the computer at minimizing waste."
params: 
    source: "Cornell University DASL Project. The data and story library. Website. http://lib.stat.cmu.edu/DASL/Datafiles/wasterunupdat.html. "
    pins_name: 'hathawayj/dasl_waste_run_up'
    available: all
---
...
- __Source:__ Plant number
- __RunUp:__ Percentage waste (run-up)
...
#| file: ../../../data_scripts/intro_stats/dasl_waste_run_up.R
```
