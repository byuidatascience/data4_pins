...
author: "MATH 221"
date: "2024-03-13"
categories: [population, health, anthropology]
description: "The Mater Mothers’ Hospital is a busy hospital in Brisbane, Australia. The birth weights and times of all children born on December 18, 1997 in this hospital were recorded. "
params: 
    source: "S Steele. Babies by the dozen for Christmas: 24-hour baby boom. The Sunday Mail (Brisbane), page 7, December 21, 1997.\nPeter K. Dunn. A simple dataset for demonstrating common distributions. Journal of Statistics Education, 7(3), 1999. "
    pins_name: 'hathawayj/baby_boom'
    available: all
---
...
- __Time__ Time of birth, 24-hour clock (2010 = 8:10 PM)
- __Gender__ Gender of baby (1 - female, 2 = male)
- __Weight__ Weight of baby (grams)
- __Minutes__ Number of minutes past midnight the baby was born
- __WaitTimes__ Number of minutes between the current and previous births 
...
#| file: ../../../data_scripts/intro_stats/baby_boom.R
```
