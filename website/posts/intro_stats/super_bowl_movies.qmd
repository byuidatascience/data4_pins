...
description: "Revenue of films and whether or not they were advertised during the Superbowl or not"
params: 
    source: "WorldwideBoxOffice.com. Website. http://www.worldwideboxoffice.com/.  "
    pins_name: 'hathawayj/super_bowl_movies'
    available: all
---
...
- __Year:__ Release Year
- __AdvertisedinSuperBowl:__ Whether movie was advertised in Superbowl or not (No, Yes)
- __Title:__ Movie title
- __GrossRevenueMillion:__ Gross Revenue (millions of dollars)
...
#| file: ../../../data_scripts/intro_stats/super_bowl_movies.R
```
