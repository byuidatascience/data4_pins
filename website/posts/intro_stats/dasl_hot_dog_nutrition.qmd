...
author: "MATH 221"
date: "2024-04-27"
categories: [products, health, food]
description: "Calorie and sodium contents of different types of hot dogs"
params: 
    source: "Cornell University DASL Project. The data and story library. Website. http://lib.stat.cmu.edu/DASL/ "
    pins_name: 'hathawayj/dasl_hot_dog_nutrition'
    available: all
---
...
- __Type:__ Type of hot dog (beef, meat, poultry)
- __Calories:__ Calorie content (calories)
- __Sodium:__ Sodium content (mg) 
...
#| file: ../../../data_scripts/intro_stats/dasl_hot_dog_nutrition.R
```
