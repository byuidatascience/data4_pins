...
description: "The size of eggs that cuckoos lay in the nests of other species"
params: 
    source: "Unknown"
    pins_name: 'hathawayj/cuckoo_eggs'
    available: all
---
...
- __HostSpecies:__ Species of the bird in which a cuckoo laid its egg
- __LengthofCuckooEggs:__ Cuckoo egg length (millimeters)
...
#| file: ../../../data_scripts/intro_stats/cuckoo_eggs.R
```
