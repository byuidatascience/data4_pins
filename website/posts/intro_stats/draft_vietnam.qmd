...
author: "MATH 221"
date: "2024-04-29"
categories: [MATH221, politics, war]
description: "An aggregated dataset that totals the amount of people drafted for the Vietnam War over time"
params: 
    source: "Unknown"
    pins_name: 'hathawayj/draft_vietnam'
    available: all
---
...
- __day_month:__ Day of the month
- __day_year:__ Day of the year
- __month:__ Month (number)
- __month_name:__ Month (name)
- __n69:__ Count of people drafted for each day during 1969
- __n70:__ Count of people drafted for each day during 1970
- __n71:__ Count of people drafted for each day during 1971
- __n72:__ Count of people drafted for each day during 1972
...
#| file: ../../../data_scripts/intro_stats/draft_vietnam.R
```
