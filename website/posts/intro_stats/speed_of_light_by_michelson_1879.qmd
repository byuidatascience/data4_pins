...
author: "MATH 221"
date: "2024-05-02"
categories: [MATH221, science, physics]
description: "In 1879, Albert Abraham Michelson, an American physicist, published several observations of the speed of light in air.  This was early in his quest to measure the speed of light accurately.\nThe speed of light in a vacuum is currently defined as 299 792 458 meters per second.  The speed of light through air is about 90 000 meters per second slower. \nMichelson used some improvised equipment to collect this data set. "
params: 
    source: "Ernest N. Dorsey. The velocity of light. Transactions of the American Philosophical Society, 34(1):1-110, 1944.\nNational Institute of Standards and Technology (NIST). Data gallery: Michelson speed of light. Website. http://www.itl.nist.gov/div898/bayesian/datagall/michelso.htm "
    pins_name: 'hathawayj/speed_of_light_by_michelson_1879'
    available: all
---
...
- __SpeedOfLight:__ Speed of light (millions of meters per second)
- __Temp:__ Temperature (F)
- __Day:__ Day of the month
- __TimeOfDay:__ (AM/PM)
- __Set:__ Identification number of dataset (1 to 24)
...
#| file: ../../../data_scripts/intro_stats/speed_of_light_by_michelson_1879.R
```
