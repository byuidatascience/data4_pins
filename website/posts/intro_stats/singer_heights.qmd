...
author: "MATH 221"
date: "2024-05-02"
categories: [MATH221, music]
description: "The heights of singers by their group (Soprano, Alto, Tenor, Bass)"
params: 
    source: "Unknown"
    pins_name: 'hathawayj/singer_heights'
    available: all
---
...
- __Soprano__ Singer height (inches)
- __Alto__ Singer height (inches)
- __Tenor__ Singer height (inches)
- __Bass__ Singer height (inches)
...
#| file: ../../../data_scripts/intro_stats/singer_heights.R
```
