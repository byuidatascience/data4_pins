...
description: "The GPAs of various BYUI students"
params: 
    source: "Unknown"
    pins_name: 'hathawayj/gpas_byui'
    available: all
---
...
- __Age:__ Student age
- __GPA:__ GPA (0-4)
- __Major:__ Student major
...
#| file: ../../../data_scripts/intro_stats/gpas_byui.R
```
