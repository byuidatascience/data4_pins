...
description: "In his landmark paper on the t-distribution, William S. Gosset referenced data on the number of additional hours of sleep patients obtained by using the drug laevohysocyamine hydrobromide.  If the drug is not effective, then the mean number of addition hours of sleep should be zero."
params: 
    source: "W. S. Gosset. The probable error of a mean. Biometrika, 6:1-25, 1908.  "
    pins_name: 'hathawayj/dasl_student'
    available: all
---
...
- __AdditionalSleep:__ Hours of additional sleep gained by patients from using the drug
...
#| file: ../../../data_scripts/intro_stats/dasl_student.R
```
