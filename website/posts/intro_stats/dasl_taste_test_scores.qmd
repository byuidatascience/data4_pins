...
- __Score:__ Palatability score
- __Screen:__ Screen type (Coarse, Fine)
- __Liquid:__ Concentration of a liquid component (High, Low)
...
#| file: ../../../data_scripts/intro_stats/dasl_taste_test_scores.R
```
