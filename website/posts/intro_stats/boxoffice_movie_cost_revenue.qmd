...
description: "The budget and worldwide revenue of movies released from 1991 to 2015"
params: 
    source: "Unknown"
    pins_name: 'hathawayj/boxoffice_movie_cost_revenue'
    available: all
---
...
- __Release.Date:__ Date the movie was released (MM/DD/YYYY) 
- __Movie:__ Movie title
- __Production.Budget:__ Production Budget (dollars)
- __Worldwide.Gross:__ Money the movie made at box offices worldwide (dollars)
...
#| file: ../../../data_scripts/intro_stats/boxoffice_movie_cost_revenue.R
```
