...
description: "Percent return of the 3 stock picking options (DARTS, DJIA, PROS)"
params: 
    source: "Bro. Hathaway"
    pins_name: 'hathawayj/dart_expert_dow_6month_anova'
    available: all
---
...
- __contest_period:__ Time period
- __variable:__ The 3 stock-picking options (DARTS, DJIA, PROS)
- __value:__ Percent change in stock value for that period
...
#| file: ../../../data_scripts/intro_stats/dart_expert_dow_6month_anova.R
```
