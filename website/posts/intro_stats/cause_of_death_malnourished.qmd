...
author: "MATH 221"
date: "2024-04-25"
categories: [MATH221, health, nutrition, mortality]
description: "Researchers used forensic autopsy results to assess the causes of death in several malnourished people in Japan.  The ultimate goal of the research is to reduce premature death in this vulnerable population.  People were identified as malnourished if their body mass index (BMI) was less than 16."
params: 
    source: "Hideto Suzuki, Takanobu Tanifuji, Nobuyuki Abe, and Tatsushige Fukunaga. Causes of death in forensic autopsy cases of malnourished persons. Legal Medicine, In press, 2012."
    pins_name: 'hathawayj/cause_of_death_malnourished'
    available: all
---
...
- __Gender:__ Gender (Male, Female)
- __Disease:__ Disease recorded as cause of death
- __Age:__ Age group (20-54, 55-64, 65-74, 75+)
- __Count:__ Count of people that died of a certain disease in a certain age group
...
#| file: ../../../data_scripts/intro_stats/cause_of_death_malnourished.R
```
