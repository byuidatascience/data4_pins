...
params: 
    ...
    pins_name: 'hathawayj/marathon_berlin'
    available: all
---
...
- __age:__ The age of the runner  
- __gender:__ The gender of the runner (M/F)  
- __chiptime:__ The time in minutes for the runner  
- __year:__ The year of the marathon  
- __marathon:__ The name of the marathon  
- __country:__ The country where the marathon was held  
- __finishers:__ The number of finishers at the marathon  
...
#| file: ../../../data_scripts/marathon/marathon_berlin.R
```
