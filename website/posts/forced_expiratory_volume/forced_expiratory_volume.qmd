...
date: "2024-04-29"
categories: [health]
description: "Forced expiratory volume is the amount of air a person can exhale during a forced breath. This dataset includes the forced expiratory volume of various youths under 20 years of age."
params: 
    source: ""
...
- __Age__ Person age (years)
- __FEV__ Forced expiratory volume (liters)
- __Height__ Person height (inches)
- __Gender__ Gender (Female, Male)
- __SmokingStatus__ Smoking status (Smoker, Nonsmoker)
