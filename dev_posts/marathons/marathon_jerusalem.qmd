...
params: 
    ...
    pins_name: 'hathawayj/marathon_jerusalem'
    available: all
---
...
- __age__ The age of the runner
- __gender__ The gender of the runner (M/F)
- __chiptime__ The time in minutes for the runner
- __year__ The year of the marathon
- __marathon__ The name of the marathon
- __country__ The country where the marathon was held
...
#| file: ../../../data_scripts/marathon/marathon_jerusalem.R
```
