...
description: "Data from a survey of students"
params: 
    source: ""
...
- __Class__ Unclear, appears to refer to class to which student pertains
- __Gender__ Gender (M/F)
- __Hand__ Dominant hand (R/L)
- __Roll__ Unknown (Y/N)
- __Flip__ Unknown (Y/N)
- __Nose__ Unknown (Y/N)
- __Penny__ Unknown (Y/N)
- __Rank__ Class in school (FR, JR, SO, SR)
- __Credits__ Total credits taken in school
- __Height__ Student height (inches)
- __Fear__ Unknown (numeric)
- __Skill__ Unknown (numeric)
- __State__ Two-letter code of state, or name of country
- __Wage__ Hourly wage (dollars)
- __Age__ Age (years)
- __Date__ Unknown (Y/N)
- __Random__ Unknown (numeric)
