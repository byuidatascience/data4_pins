...
- __Score__ Percent of questions right on exam
- __ConfidenceRatingMean__ Mean of confidence ratings for each student (see description for scale)
...
#| file: ../../../data_scripts/math_self_efficacy.R
```
