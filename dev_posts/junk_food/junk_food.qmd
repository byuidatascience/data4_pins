...
description: "Calorie information for various foods"
params: 
    source: ""
    pins_name: 'hathawayj/junk_food'
    available: all
---
...
- __Food__ Food
- __ServingSize__ Serving size (grams)
- __Calories__ Calories
- __CalPerGram__ Calories per gram (Cal/g)
