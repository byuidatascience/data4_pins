---
title: "Used Hummers: NY and LA"
author: "MATH 221"
date: "2024-05-02"
categories: [vehicles, products]
description: "Data on various used hummers in New York and Los Angeles"
params: 
    source: ""
    pins_name: 'hathawayj/used_hummers_ny_and_la'
    available: all
---
...
- __Year__ Year
- __Make__ Vehicle make
- __Model__ Vehicle model
- __Price__ Vehicle price (dollars)
- __Mileage__ Mileage
- __Seller__ Seller Name and phone number
- __Type.Of.Seller__ Seller type (Dealer, Individual)
- __Body__ Body (SUV)
- __Color__ Vehicle Color
- __City__ City (Los Angeles, New York)
...
#| file: ../../../data_scripts/used_hummers_ny_and_la.R
```
