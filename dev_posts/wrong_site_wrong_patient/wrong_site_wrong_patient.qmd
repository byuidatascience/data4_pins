...
- __Wrong.Site__ Costs incurred by hospital from wrong site errors (dollars)
- __Wrong.Patient__ Costs incurred by hospital from wrong patient errors (dollars)
...
#| file: ../../../data_scripts/wrong_site_wrong_patient.R
```
