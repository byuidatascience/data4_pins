...
params: 
    source: ""
    pins_name: 'hathawayj/isr_daycare'
    available: all
---
...
- __Center__ A unique key for each daycare center
- __children__ Quantity of children
- __type__ Daycare type (Fee, No Fee)
- __pre__ Score before treatment
- __post__ Score after treatment
...
#| file: ../../../data_scripts/isr_daycare.R
```
