---
title: "Direct Flight Costs"
author: "MATH 221"
date: "2024-04-29"
categories: [business, transportation]
description: "Costs of various direct flights from the Heathrow Airport"
params: 
    source: ""
    pins_name: 'hathawayj/direct_flights_cost'
    available: all
---
...
- __Origin__ Airport from which flight originated (all Heathrow)
- __Destination__ Airport at which flight arrived
- __FourteenDays__ Flight cost 14 days before day of flight
- __NinetyDays__ Flight cost 90 days before day of flight
...
#| file: ../../../data_scripts/direct_flights_cost.R
```
