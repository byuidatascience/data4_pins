...
author: "DS 350"
date: "2024-05-08"
categories: [world, environmentalhealth, health]
...
- __entity__ Whether the metric is a 95th percentile or a median (95th percentile, Median)
- __code__ Normally the 3-letter code for each country in OWID datasets, but empty in this dataset because it's irrelevant
- __year__ Year
- __Lead blood concentrations in children__ (micrograms per deciliter)
