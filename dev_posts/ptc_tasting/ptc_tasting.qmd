...
date: "2024-05-01"
categories: []
description: "Phenylthiocarbamide (PCT) is a chemical compound that some people can taste while others can't. This is an aggregated dataset of those who can and cannot taste PCT. "
params: 
    source: ""
    pins_name: 'hathawayj/ptc_tasting'
    available: all
---
...
- __Gender__ Gender group (Females, Males)
- __CanTaste__ Whether subject was able to test PCT or not (No, Yes)
- __Count__ Count of people in gender and tasting group
...
#| file: ../../../data_scripts/ptc_tasting.R
```
