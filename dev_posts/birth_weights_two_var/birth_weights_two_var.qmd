...
author: "MATH 221"
date: "2024-03-13"
categories: [health, population]
description: "Birth weights of black children in Africa and in the US."
params: 
    source: ""
    pins_name: 'hathawayj/birth_weights_two_var'
    available: all
---
...
- __Black_Africa__ African baby birth weight (grams)
- __Black_US__ American baby birth weight (grams)
...
#| file: ../../../data_scripts/birth_weights_two_var.R
```
