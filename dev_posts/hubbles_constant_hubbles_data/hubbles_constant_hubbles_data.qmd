---
title: "Hubble's Constant: Hubble's Data"
author: "MATH 221"
date: "2024-04-30"
categories: [astronomy, physics]
description: "Recession velocity (rate at which an object recedes from view) and distance from the Earth of the Hubble Space Telescope"
params: 
    source: ""
    pins_name: 'hathawayj/hubbles_constant_hubbles_data'
    available: all
---
...
- __DistanceFromEarth__ Distance of the Hubble Space Telescope from Earth
- __RecessionVelocity__ Rate at which the telescope recedes from view
...
#| file: ../../../data_scripts/hubbles_constant_hubbles_data.R
```
