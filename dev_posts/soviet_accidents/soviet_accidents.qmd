...
description: "Dr. Wm. Robert Johnston compiled a list of nuclear accidents on Soviet submarines that caused acute radiation casualties, together with information such as how many deaths occurred.   "
params: 
...
- __Date__ Date (MM/DD/YYYY)
- __Location__ Submarine involved in accident, Location of accident
- __TypeofAccident__ Type of accident
- __Deaths__ Count of deaths associated with each accident
...
#| file: ../../../data_scripts/soviet_accidents.R
```
