...
author: "DS 350"
date: "2024-05-08"
categories: [world, climate]
description: "The amount of sea ice in Antarctica over time"
params: 
    source: "https://ourworldindata.org/explorers/climate-change?facet=none&country=OWID_WRL~ATA&Metric=Antarctic+sea+ice+extent&Long-run+series%3F=false"
    pins_name: 'hathawayj/climate_change_antarctica'
    available: all
---
...
- __Year__ Year
- __antarctic_sea_ice_september__ Amount of sea ice in Antarctica in September (millions of square kilometers)
- __antarctic_sea_ice_february__ Amount of sea ice in Antarctica in February (millions of square kilometers)
...
#| file: ../../../data_scripts/climate_change_antarctica.R
```
