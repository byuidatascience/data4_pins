...
author: "DS 350"
date: "2024-05-09"
categories: [DS350, infrastructure, idaho, resources, geospatial]
...
- __OBJECTID:__ A unique ID for each object
- __WellID:__ A unique ID for each well
- __PermitID:__ A unique ID for each permit
- __MetalTagNu:__ Some kind of unique id
- __CurrentSta:__ Empty column
- __Constructi:__ (YYYY-MM-DD)
- __Owner:__ Owner name (FIRSTNAME LASTNAME)
- __AppType:__ Empty column
- __WellUse:__ Thing for which well is being used
- __BasinNumbe:__ Unknown (integer)
- __CountyName:__ County name
- __Township:__ Unknown
- __Range:__ Unknown
- __Section:__ Unknown (integer)
- __QQQ:__ Unknown (NE, NW, SE, SW)
- __QQ:__ Unknown (NE, NW, SE, SW)
- __Quarter:__ Unknown (NE, NW, SE, SW)
- __GovLotNum:__ Empty column
- __WellAddres:__ Address of well (directions from landmarks)
- __Lot:__ Unknown
- __Block:__ Unknown
- __subdivisio:__ Subdivision name
- __Production:__ Well production (gallons)
- __StaticWate:__ Static water level: amount of water (distance from measuring point to water level in the well) under normal conditions, while at rest
- __CasingDiam:__ Well casing diameter
- __CasingDept:__ Well casing depth
- __TotalDepth:__ Total well depth
- __DataSource:__ Source of data
- __DiversionN:__ Empty column
- __WellDocs:__ Link to Idaho Department of Water Resources (IDWR) documents, including well driller reports
- __Latitude:__ Empty column
- __Longitude:__ Empty column
- __SpatialDat:__ Unknown
- __geometry:__ Geometry column for geospatial visualizations
