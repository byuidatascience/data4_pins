...
date: "2024-04-29"
categories: [housing]
description: "Data on various properties in Madison County"
params: 
    source: ""
...
- __Age__ House age (years)
- __LotSize__ Size of lot (acres)
- __SQFT__ Square footage (ft^2^)
- __Taxes__ .
- __IsFixerUpper__ Whether property needs repairs or not (No, Yes)
- __Elementary__ Elementary school property is in the boundaries for
- __JrHigh__ Junior High school property is in the boundaries for
- __High__ High school property is in the boundaries for
...
- __FloodPlain__ Whether property is built on flood plain or not (N, U, Y)
