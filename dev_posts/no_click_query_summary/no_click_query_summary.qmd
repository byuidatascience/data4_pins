---
title: "No Click Query (Summary)"
author: "MATH 221"
date: "2024-05-01"
categories: [technology]
description: "An aggregated version of no_click_query. Includes a count of each type of result."
params: 
    source: "Stamou and Efthimiadis, Queries without Clicks: Successful or failed searches?
Proceedings of the SIGIR 2009 Workshop on the Future of IR Evaluation
Boston, MA,  23 July 2009"
    pins_name: 'hathawayj/no_click_query_summary'
    available: all
---
...
- __Reason__ Category of results for no click query
- __Details.for.Result.of.Query.with.No.Clicks__  Results for no click query
- __Count__ Count of query results of that category
...
#| file: ../../../data_scripts/no_click_query_summary.R
```
