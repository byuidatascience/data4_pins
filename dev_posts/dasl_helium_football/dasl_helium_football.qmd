...
- __Trial__ An ID for each trial
- __Helium__ Distance the helium football traveled (yards) 
- __Air__ Distance the air football traveled (yards) 
...
#| file: ../../../data_scripts/dasl_helium_football.R
```
