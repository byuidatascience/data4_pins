...
description: "The salaries of various NBA players"
params: 
    source: ""
    pins_name: 'hathawayj/nba_salaries'
    available: all
---
...
- __Year__ Unknown
- __Player__ Player name (Lastname, Firstname)
- __Salary__ Yearly salary (dollars)
- __Position__ Position on team (C, C-F, F, F-C, F-G, G, G-F)
- __Team__ Team name
- __NA.__ Empty column
- __NA..1__ Empty column
...
#| file: ../../../data_scripts/nba_salaries.R
```
