...
- __Vehicle__ Name
- __Model__ Model
- __Price__ Price (dollars)
- __Mileage__ Mileage (miles)
- __Seller__ Seller
- __Body__ Vehicle body type (Coupe, Sedan, SUV, Wagon, Unknown)
- __Color__ Color (Black, Blue, Green, Red, Silver, White, Other)
- __IsSaturnDealer__ If dealer is Saturn or not (0, 1)
- __NonSaturnDealer__ (0, 1)
- __City__ City
- __Distance__ unknown
