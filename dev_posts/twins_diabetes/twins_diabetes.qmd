...
- __Twin__ ID for each pair of twins
- __Age__ Age at time of diagnosis (years)
- __Gender__ Gender of twins (M, F)
- __NonDiabeticHeight__ Height of non-diabetic twin (cm)
- __DiabeticHeight__ Height of diabetic twin (cm)
...
#| file: ../../../data_scripts/twins_diabetes.R
```
