...
description: "Data on on various 2005 Toyota vehicles"
params: 
    source: ""
...
- __Year__ Year
- __Vehicle__ Vehicle name
- __IsCertified__ Whether vehicle is certified or not (No, Yes)
- __Price__ Vehicle price
- __Mileage__ Mileage
- __Seller__ Seller Name and Phone Number
- __TypeOfSeller__ Seller type (Dealer, Private)
- __Body__ unknown
...
#| file: ../../../data_scripts/toyota_prius_2005.R
```
