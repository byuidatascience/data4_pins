---
title: "CPI Average Prices: January 2020"
author: "DS 350"
date: "2024-05-21"
categories: [DS350, CPIindex, prices, finance]
description: "This dataset can be combined with the other CPI datasets after some wrangling.\nThe Consumer Price Index (CPI) is a way to measure the average change in prices of various consumer products. This dataset contains CPI information from January 2020 in the UK."
params: 
    source: ""
    pins_name: 'hathawayj/cpiaverageprices202001'
    available: all
---
...
- __CPI Average Prices 2020:__ A unique key for each product
...
#| file: ../../../data_scripts/cpiaverageprices202001.R
```
