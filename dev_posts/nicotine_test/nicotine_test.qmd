...
- __Cotinine.Level__ Level of Cotinine (metabolized nicotine) found in newborn meconium (first stool after birth, indicative of things that fetus ingested in utero)
- __Group__ Mother group (Active Smoker, Nonsmoker, Passive Smoker)
...
#| file: ../../../data_scripts/nicotine_test.R
```
