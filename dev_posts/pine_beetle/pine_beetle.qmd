...
- __TreeStand:__ A unique key that identifies each treestand from which pines were observed
- __Before:__ Number of lodgepole pines per hectare before a mountain pine beetle outbreak
- __After:__ Number of lodgepole pines per hectare after a mountain pine beetle outbreak
...
#| file: ../../../data_scripts/intro_stats/pine_beetle.R
```
