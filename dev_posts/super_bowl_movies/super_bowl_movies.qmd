...
- __AdvertisedinSuperBowl__ Whether movie was advertised in Superbowl or not (No, Yes)
- __Title__ Movie title
- __GrossRevenueMillion__ Gross Revenue (millions of dollars)
...
#| file: ../../../data_scripts/super_bowl_movies.R
```
