...
description: "The results of eating various crackers"
params: 
    source: ""
    pins_name: 'hathawayj/dasl_fiber'
    available: all
---
...
- __Cracker__ Cracker type (control, bran, combo, gum)
- __Diet__ Which diet subject was on
- __Subject__ An ID for each subject
- __Digested__ Unknown
- __Bloat__ How much bloating subject experienced (none, low, med, high)
...
#| file: ../../../data_scripts/dasl_fiber.R
```
