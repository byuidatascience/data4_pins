...
- __Date__ Date (Monthname day, YYYY)
- __HeartAttacks__ Count of heart attacks
- __TimePeriod__ Time period group (Control, World Cup)
...
#| file: ../../../data_scripts/world_cup_heart_attacks.R
```
