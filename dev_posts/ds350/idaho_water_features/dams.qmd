...
- __FID:__ A unique ID that identifies each row
- __DamID:__ A unique ID for each dam
- __NIDID:__ An ID
- __StateID:__ Unknown (may be related to water rights?)
- __DamName:__ Name of dam
- __Status:__ Dam status (BREACHED, NON REGULATED, PENDING, RECLAIMED, REGULATED)
- __YearComple:__ Year dam was completed (up to 2014)
- __YearModifi:__ Year Modified
- __DamHeight:__ Dam height (ft)
- __HydraulicH:__ Unknown (decimal)
- __NormalStor:__ Unknown (decimal)
- __SurfaceAre:__ Dam surface area (acres)
- __DrainageAr:__ Unknown (decimal)
- __DownStream:__ Unknown (HIGH, LOW, NOT RATED, SIGNIFICANT)
- __Source:__ Source of water feature
- __SourceQual:__ Unknown (LITTLE NORTH FORK SOUTH FORK, NORTH FORK, SOUTH FORK, MIDDLE FORK, NORTHEAST FORK, WEST FORK)
- __TributaryO:__ Tributary name
- __Tributar_1:__ Unknown (EAST FORK, EAST FORK SOUTH FORK, MIDDLE FORK, NORTH FORK, SECOND FORK, SOUTH FORK, WEST FORK)
- __DataSource:__ Source of data (Digitized, GPS - Downloaded, GPS - Manually Entered)
- __MetalTagNu:__ Unkown key, mostly null
- __TRS:__ Unknown
- __County:__ County name
- __SpatialDat:__ Unknown (mostly unique values for each row)
